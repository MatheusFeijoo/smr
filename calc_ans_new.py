...
def Leadership(df_pol, dfL1Best, dfL2Best, dfL3Best, dfL4Best):
    ...
    L1S1 = (((df_pol[0]['L1Q1'])/(data.dfL1Best[0]-2)>=1 and (1,) or (0,))[0])
    L1M1 = (((df_pol[0]['L1Q1'])/(data.dfL1Best[0]-2)>=1 and (((df_pol[0]['L1Q1']-1)/(data.dfL1Best[0]-2)<1 and ((df_pol[0]['L1Q1'])/(data.dfL1Best[0]-1),) or (1,))[0],) or (0,))[0])
    L1A1 = (((df_pol[0]['L1Q1'])/(data.dfL1Best[0]-2)>=1 and ((df_pol[0]['L1Q1'])/(data.dfL1Best[0]),) or (0,))[0])
    L1Q2MEAN = (df_pol[0]['L1Q2'] + df_pol[0]['L1Q3'])/2
    ...
    L1T2 = ((L1R2>=0.75 and (((df_pol[0]['L1Q5']>1 and ((df_pol[0]['L1Q5'])/(data.dfL1Best[3]),) or (0,))[0]),) or (0,))[0])
    L1M3 = ((df_pol[0]['L1Q4']==0 and (0,) or ((df_pol[0]['L1Q4'])/(data.dfL1Best[2]),))[0])
    #L2
    L2M1 = (((((df_pol[0]['L2Q1'])/(data.dfL2Best[0]-3)>=1 and (1,) or (0,))[0])+(((df_pol[0]['L2Q2'])/(data.dfL2Best[1]-3)>=1 and (1,) or (0,))[0]))/2)
    L2A1 = (((((df_pol[0]['L2Q1'])/(data.dfL2Best[0]-3)>=1 and (((df_pol[0]['L2Q1']-1)/(data.dfL2Best[0]-3)>1 and (1,) or ((df_pol[0]['L2Q1'])/(data.dfL2Best[0]-2),))[0],) or (0,))[0])+(((df_pol[0]['L2Q2'])/(data.dfL2Best[1]-3)>=1 and (((df_pol[0]['L2Q2']-1)/(data.dfL2Best[1]-3)>1 and (1,) or ((df_pol[0]['L2Q2'])/(data.dfL2Best[1]-2),))[0],) or (0,))[0]))/2)
    L2R1 = (((((df_pol[0]['L2Q1'])/(data.dfL2Best[0]-3)>=1 and (((df_pol[0]['L2Q1']-1)/(data.dfL2Best[0]-2)>1 and (1,) or ((df_pol[0]['L2Q1'])/(data.dfL2Best[0]-1),))[0],) or (0,))[0])+(((df_pol[0]['L2Q2'])/(data.dfL2Best[1]-3)>=1 and (((df_pol[0]['L2Q2']-1)/(data.dfL2Best[1]-2)>1 and (1,) or ((df_pol[0]['L2Q2'])/(data.dfL2Best[1]-1),))[0],) or (0,))[0]))/2)
    L2T1 = (((((df_pol[0]['L2Q1'])/(data.dfL2Best[0]-3)>=1 and (((df_pol[0]['L2Q1']-1)/(data.dfL2Best[0]-1)>1 and (1,) or ((df_pol[0]['L2Q1'])/(data.dfL2Best[0]),))[0],) or (0,))[0])+(((df_pol[0]['L2Q2'])/(data.dfL2Best[1]-3)>=1 and (((df_pol[0]['L2Q2']-1)/(data.dfL2Best[1]-1)>1 and (1,) or ((df_pol[0]['L2Q2'])/(data.dfL2Best[1]),))[0],) or (0,))[0]))/2)
    #L3
    L3S1 = (((df_pol[0]['L3Q1'])/(data.dfL3Best[0])>=1 and (1,) or (0,))[0])
    L3M1 = (((df_pol[0]['L3Q1'])/(data.dfL3Best[0]-1)>=1 and (((df_pol[0]['L3Q1'])/(data.dfL3Best[0])),) or (0,))[0])
    L3T1 = ((L3M1>=0.75 and ((df_pol[0]['L3Q1']>=3 and (((df_pol[0]['L3Q3']>1 and (((df_pol[0]['L3Q3'])/(data.dfL3Best[2])),) or (0,))[0]),) or (0,))[0],) or (0,))[0])
    L3M2 = ((df_pol[0]['L3Q2']>1 and ((((df_pol[0]['L3Q2'])/(data.dfL3Best[1]-1)>=1 and (1,) or ((df_pol[0]['L3Q2'])/(data.dfL3Best[1]),))[0]),) or (0,))[0])
    L3A2 = ((((df_pol[0]['L3Q2']>1 and ((((df_pol[0]['L3Q2']-1)/(data.dfL3Best[1]-1)>=1 and (1,) or ((df_pol[0]['L3Q2'])/data.dfL3Best[1],))[0]),) or (0,))[0])+((df_pol[0]['L3Q4']>1 and ((((df_pol[0]['L3Q4'])/(data.dfL3Best[3]-1)>=1 and (1,) or ((df_pol[0]['L3Q4'])/(data.dfL3Best[3]),))[0]),) or (0,))[0]))/2)
    L3R2 = ((df_pol[0]['L3Q4']>1 and ((df_pol[0]['L3Q4']-1)/(data.dfL3Best[3]-1),) or (0,))[0])
    L3T2 = ((L3R2>=0.75 and (((df_pol[0]['L3Q5']>1 and ((df_pol[0]['L3Q5']/data.dfL3Best[4]),) or (0,))[0]),) or (0,))[0])
    #L4
    L4S1 = ((df_pol[0]['L4Q6']>1 and ((((df_pol[0]['L4Q6'])/(data.dfL4Best[5]-2)>1 and (1,) or ((df_pol[0]['L4Q6'])/(data.dfL4Best[5]-2),))[0]),) or (0,))[0])
    L4A1 = ((df_pol[0]['L4Q6']>1 and (((df_pol[0]['L4Q6']-1)/(data.dfL4Best[5]-1)),) or (0,))[0])
    L4S2 = ((df_pol[0]['L4Q1']>1 and (((df_pol[0]['L4Q1']-1)/(data.dfL4Best[0]-1)),) or (0,))[0])
    L4M2 = ((((L4S2>=0.75 and (((df_pol[0]['L4Q2']>1 and (((df_pol[0]['L4Q2']/(data.dfL4Best[1]-2)<1 and ((df_pol[0]['L4Q2']/(data.dfL4Best[1]-2)),) or (1,))[0]),) or (0,))[0]),) or (0,))[0])+(((df_pol[0]['L4Q4'])/(data.dfL4Best[3]-1)>=1 and (1,) or ((df_pol[0]['L4Q4'])/(data.dfL4Best[3]-1),))[0]))/2)
    L4A2 = (((L4M2>=0.75 and ((((df_pol[0]['L4Q2']-1)/(data.dfL4Best[1]-2)>1 and (1,) or ((df_pol[0]['L4Q2']-1)/(data.dfL4Best[1]-2),))[0]),) or (0,))[0]+(df_pol[0]['L4Q4']/data.dfL4Best[3]))/2)
    L4R2 = ((L4A2>=0.75 and (((df_pol[0]['L4Q2']>1 and ((df_pol[0]['L4Q2']-1)/(data.dfL4Best[1]-1),) or (0,))[0]),) or (0,))[0])
    L4M3 = ((df_pol[0]['L4Q3'])/(data.dfL4Best[2]))
    L4T3 = ((L4M3>=0.75 and (((df_pol[0]['L4Q7']>1 and (((df_pol[0]['L4Q7']-1)/(data.dfL4Best[6]-1)),) or (0,))[0]),) or (0,))[0])
    L4A4 = ((df_pol[0]['L4Q5']>1 and (((df_pol[0]['L4Q5']-1)/(data.dfL4Best[4]-1)),) or (0,))[0])
    print(df_pol)
    print()
