...
def Leadership(df_pol, dfL1Best, dfL2Best, dfL3Best, dfL4Best):
    ...
    L1M2 = (((L1Q2MEAN)/(data.dfL1Best[1]-3)>=1 and (((L1Q2MEAN-1)/(data.dfL1Best[1]-3)>1 and (1,) or ((L1Q2MEAN-1)/(data.dfL1Best[1]-3),))[0],) or (0,))[0])
    L1A2 = (((L1Q2MEAN)/(data.dfL1Best[1]-3)>=1 and (((L1Q2MEAN-1)/(data.dfL1Best[1]-2)>1 and (1,) or ((L1Q2MEAN-1)/(data.dfL1Best[1]-2),))[0],) or (0,))[0])
    L1R2 = (((L1Q2MEAN)/(data.dfL1Best[1]-3)>=1 and (((L1Q2MEAN-1)/(data.dfL1Best[1]-1)>1 and (1,) or ((L1Q2MEAN-1)/(data.dfL1Best[1]-1),))[0],) or (0,))[0])
    L1T2 = ((L1R2>=0.75 and (((df_pol['L1Q5']>1 and ((df_pol['L1Q5']-1)/(data.dfL1Best[3]-1),) or (0,))[0]),) or (0,))[0])
    L1M3 = ((df_pol['L1Q4']==0 and (0,) or ((df_pol['L1Q4']-1)/(data.dfL1Best[2]-1),))[0])
    #L2
