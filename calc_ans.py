...
def Leadership(df_pol, dfL1Best, dfL2Best, dfL3Best, dfL4Best):
    ...
    L1M1 = (((df_pol['L1Q1'])/(data.dfL1Best[0]-2)>=1 and (((df_pol['L1Q1']-1)/(data.dfL1Best[0]-2)<1 and ((df_pol['L1Q1']-1)/(data.dfL1Best[0]-2),) or (1,))[0],) or (0,))[0])
    L1A1 = (((df_pol['L1Q1'])/(data.dfL1Best[0]-2)>=1 and ((df_pol['L1Q1']-1)/(data.dfL1Best[0]-1),) or (0,))[0])
    L1S2 = (((df_pol['L1Q2'])/(data.dfL1Best[1]-3)>=1 and (1,) or (0,))[0])
    L1M2 = (((df_pol['L1Q2'])/(data.dfL1Best[1]-3)>=1 and (((df_pol['L1Q2']-1)/(data.dfL1Best[1]-3)>1 and (1,) or ((df_pol['L1Q2']-1)/(data.dfL1Best[1]-3),))[0],) or (0,))[0])
    L1A2 = (((df_pol['L1Q2'])/(data.dfL1Best[1]-3)>=1 and (((df_pol['L1Q2']-1)/(data.dfL1Best[1]-2)>1 and (1,) or ((df_pol['L1Q2']-1)/(data.dfL1Best[1]-2),))[0],) or (0,))[0])
    L1R2 = (((df_pol['L1Q2'])/(data.dfL1Best[1]-3)>=1 and (((df_pol['L1Q2']-1)/(data.dfL1Best[1]-1)>1 and (1,) or ((df_pol['L1Q2']-1)/(data.dfL1Best[1]-1),))[0],) or (0,))[0])
    L1T2 = ((L1R2>=0.75 and (((df_pol['L1Q4']>1 and ((df_pol['L1Q4']-1)/(data.dfL1Best[3]-1),) or (0,))[0]),) or (0,))[0])
    L1M3 = ((df_pol['L1Q3']==0 and (0,) or ((df_pol['L1Q3']-1)/(data.dfL1Best[2]-1),))[0])
    #L2
    L2M1 = (((((df_pol['L2Q1'])/(data.dfL2Best[0]-3)>=1 and (1,) or (0,))[0])+(((df_pol['L2Q2'])/(data.dfL2Best[1]-3)>=1 and (1,) or (0,))[0])+((df_pol['L2Q3']==0 and (0,) or ((df_pol['L2Q3']-1)/(data.dfL2Best[2]-1),))[0]))/3)
    L2A1 = (((((df_pol['L2Q1'])/(data.dfL2Best[0]-3)>=1 and (((df_pol['L2Q1']-1)/(data.dfL2Best[0]-3)>1 and (1,) or ((df_pol['L2Q1']-1)/(data.dfL2Best[0]-3),))[0],) or (0,))[0])+(((df_pol['L2Q2'])/(data.dfL2Best[1]-3)>=1 and (((df_pol['L2Q2']-1)/(data.dfL2Best[1]-3)>1 and (1,) or ((df_pol['L2Q2']-1)/(data.dfL2Best[1]-3),))[0],) or (0,))[0]))/2)
    L2R1 = (((((df_pol['L2Q1'])/(data.dfL2Best[0]-3)>=1 and (((df_pol['L2Q1']-1)/(data.dfL2Best[0]-2)>1 and (1,) or ((df_pol['L2Q1']-1)/(data.dfL2Best[0]-2),))[0],) or (0,))[0])+(((df_pol['L2Q2'])/(data.dfL2Best[1]-3)>=1 and (((df_pol['L2Q2']-1)/(data.dfL2Best[1]-2)>1 and (1,) or ((df_pol['L2Q2']-1)/(data.dfL2Best[1]-2),))[0],) or (0,))[0]))/2)
    L2T1 = (((((df_pol['L2Q1'])/(data.dfL2Best[0]-3)>=1 and (((df_pol['L2Q1']-1)/(data.dfL2Best[0]-1)>1 and (1,) or ((df_pol['L2Q1']-1)/(data.dfL2Best[0]-1),))[0],) or (0,))[0])+(((df_pol['L2Q2'])/(data.dfL2Best[1]-3)>=1 and (((df_pol['L2Q2']-1)/(data.dfL2Best[1]-1)>1 and (1,) or ((df_pol['L2Q2']-1)/(data.dfL2Best[1]-1),))[0],) or (0,))[0]))/2)
    #L3
    L3S1 = (((df_pol['L3Q1'])/(data.dfL3Best[0]-1)>=1 and (1,) or (0,))[0])
    L3M1 = (((df_pol['L3Q1'])/(data.dfL3Best[0]-1)>=1 and (((df_pol['L3Q1']-1)/(data.dfL3Best[0]-1)),) or (0,))[0])
    L3T1 = ((L3M1>=0.75 and ((df_pol['L3Q1']>=3 and (((df_pol['L3Q3']>1 and (((df_pol['L3Q3']-1)/(data.dfL3Best[2]-1)),) or (0,))[0]),) or (0,))[0],) or (0,))[0])
    L3M2 = ((df_pol['L3Q2']>1 and ((((df_pol['L3Q2'])/(data.dfL3Best[1]-1)>=1 and (1,) or ((df_pol['L3Q2'])/(data.dfL3Best[1]),))[0]),) or (0,))[0])
    L3A2 = ((((df_pol['L3Q2']>1 and ((((df_pol['L3Q2']-1)/(data.dfL3Best[1]-1)>=1 and (1,) or ((df_pol['L3Q2'])/data.dfL3Best[1],))[0]),) or (0,))[0])+((df_pol['L3Q4']>1 and ((((df_pol['L3Q4'])/(data.dfL3Best[3]-1)>=1 and (1,) or ((df_pol['L3Q4'])/(data.dfL3Best[3]-1),))[0]),) or (0,))[0]))/2)
...
def Urban (df_pol, dfU1Best, dfE1Best):
    #U1
    U1S1 = (df_pol['U1Q1']>1 and ((df_pol['U1Q1']-1)/(data.dfU1Best[0]-1),) or (0,))[0]
    U1M1 = (U1S1>=0.75 and (((df_pol['U1Q2']>1 and ((df_pol['U1Q2']-1)/(data.dfU1Best[1]-1),) or (0,))[0]),) or (0,))[0]
    ...
    U1S3 = (df_pol['U1Q7']>1 and ((df_pol['U1Q7']-1)/(data.dfU1Best[6]-1),) or (0,))[0]
    U1M4 = (df_pol['U1Q8']>1 and ((df_pol['U1Q8']-1)/(data.dfU1Best[7]-1),) or (0,))[0]
    U1A4 = (U1M4>=0.75 and (((df_pol['U1Q9']>1 and ((df_pol['U1Q9']-1)/(data.dfU1Best[8]-1),) or (0,))[0]),) or (0,))[0]
    U1M5 = (((df_pol['U1Q10']>1 and ((df_pol['U1Q10']-1)/(data.dfU1Best[9]-1),) or (0,))[0])+((df_pol['U1Q11']>1 and ((df_pol['U1Q11']-1)/(data.dfU1Best[10]-1),) or (0,))[0])+((df_pol['U1Q12']>1 and ((df_pol['U1Q12']-1)/(data.dfU1Best[11]-1),) or (0,))[0]))/3
    ...
    E1R2 = (E1A2>=0.75 and ((((df_pol['E1Q4']>1 and ((df_pol['E1Q4']-1)/(data.dfE1Best[3]-1),) or (0,))[0])+((df_pol['E1Q5']>1 and ((df_pol['E1Q5']-1)/(data.dfE1Best[4]-1),) or (0,))[0]))/2,) or (0,))[0]
    E1S3 = (df_pol['E1Q6']>1 and ((df_pol['E1Q6']-1)/(data.dfE1Best[5]-1),) or (0,))[0]
    E1M3 = (E1S3>=0.75 and ((((df_pol['E1Q7']>1 and ((df_pol['E1Q7']-1)/(data.dfE1Best[6]-1),) or (0,))[0])+((df_pol['E1Q8']>1 and ((df_pol['E1Q8']-1)/(data.dfE1Best[7]-1),) or (0,))[0]))/2,) or (0,))[0]
    E1A3 = (E1M3>=0.75 and ((((df_pol['E1Q9']>1 and ((df_pol['E1Q9']-1)/(data.dfE1Best[8]-1),) or (0,))[0])+((df_pol['E1Q10']>1 and ((df_pol['E1Q10']-1)/(data.dfE1Best[9]-1),) or (0,))[0])+((df_pol['E1Q11']>1 and ((df_pol['E1Q11']-1)/(data.dfE1Best[10]-1),) or (0,))[0]))/3,) or (0,))[0]
    E1R3 = (E1A3>=0.75 and (((df_pol['E1Q12']>1 and ((df_pol['E1Q12']-1)/(data.dfE1Best[11]-1),) or (0,))[0]),) or (0,))[0]
    E1A4 = (df_pol['E1Q13']>1 and ((df_pol['E1Q13']-1)/(data.dfE1Best[12]-1),) or (0,))[0]
